...
% Load images.
buildingDir = fullfile('/home/lonai/Downloads/Self_Calib/Mosaic_Pan');
...
camparam=cameraParameters('IntrinsicMatrix',transpose(KK),'RadialDistortion',...
    [kc(1,1),kc(2,1),kc(5,1)],'TangentialDistortion',[kc(3,1),kc(4,1)]);

% Read the first image from the image set.
I = read(buildingScene, 1);
[I,Origin]=undistortImage(I,camparam);
%I=imresize(Itemp,0.65);

% Initialize features for I(1)

grayImage = rgb2gray(I);
[y,x,m] =harris(grayImage,5000,'tile',[2 2],'disp');
points = [x y];
