...
public final class imud implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(gps_trans.imud.class))
            return 0L;
 
        classes.add(gps_trans.imud.class);
    ...
    public static gps_trans.imud _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        gps_trans.imud o = new gps_trans.imud();
    ...
    public gps_trans.imud copy()
    {
        gps_trans.imud outobj = new gps_trans.imud();
        outobj.ya = this.ya;
